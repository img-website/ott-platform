...
const Sidebar = () => {
    return (
        <>
            <div className='fixed inset-0 z-40 backdrop-blur-lg opacity-0 pointer-events-none'></div>
            <div className="w-72 shrink-0 h-full py-8 overflow-hidden max-lg:fixed max-lg:inset-y-0 max-lg:left-0 max-lg:z-50 max-lg:-translate-x-full">
                <div className="w-full bg-gray-800 lg:rounded-3xl shadow-lg h-full overflow-hidden p-5 flex flex-col">
                    <Link href={'/'} title='Logoipsum' className="w-full fill-white md:*:w-48 *:w-40 *:aspect-[344/62]">
                    ...
                    <div className='w-full'>
                        <Button variant="solid" className='w-full font-medium xl:text-base text-sm bg-rose-600 text-white' endContent={<IoMdLogOut />} >
                            Logout
                        </Button>
                    </div>
                </div>
