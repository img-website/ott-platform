import { Badge, Button, Dropdown, DropdownItem, DropdownMenu, DropdownTrigger, Input, User } from "@nextui-org/react";
...
const Navbar = ({sidebarIsOpen, setSidebarIsOpen}) => {
    return (
        <div className="flex items-center justify-between p-4 lg:p-8">
            <Link href={'/admin/dashboard'} title='Logoipsum' className="w-full fill-white md:*:w-48 *:w-36 *:aspect-[344/62] lg:hidden">
            ...
            <div className="w-auto">
                <div className="flex gap-4 items-center">
                    ...
                    <Badge content="5" color="danger">
                        <Button as={Link} href="/notification" isIconOnly color="warning" className="!bg-transparent" variant="bordered" aria-label="Notification">
                    ...
                    <Dropdown className="bg-gray-900 ring-1 ring-white/20 text-gray-100">
                        <DropdownTrigger>
                            <User
                        ...
                        <DropdownMenu variant="faded" aria-label="Dropdown menu with icons">
                            <DropdownItem
                                className="hover:!bg-gray-800 hover:!text-gray-100 hover:!border-gray-800"
                                key="new"
                                startContent={<IoSearch className={'text-xl text-gray-100 pointer-events-none flex-shrink-0'} />}
                            >
                                New file
                            </DropdownItem>
                            <DropdownItem
                                className="hover:!bg-gray-800 hover:!text-gray-100 hover:!border-gray-800"
                                key="copy"
                                startContent={<FaRegHeart className={'text-xl text-gray-100 pointer-events-none flex-shrink-0'} />}
                            >
                                Copy link
                            </DropdownItem>
                            <DropdownItem
                                className="hover:!bg-gray-800 hover:!text-gray-100 hover:!border-gray-800"
                                key="edit"
                                startContent={<MdOutlineNotificationsActive className={'text-xl text-gray-100 pointer-events-none flex-shrink-0'} />}
                            >
                                Edit file
                            </DropdownItem>
                            <DropdownItem
                                className="hover:!bg-rose-700 hover:!text-gray-100 hover:!border-gray-800 !text-rose-500"
                                key="delete"
                                color="danger"
                                startContent={<IoSearch className={'text-xl pointer-events-none flex-shrink-0'} />}
                            >
                                Delete file
                            </DropdownItem>
                        </DropdownMenu>
